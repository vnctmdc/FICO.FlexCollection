...
export default class SMX {
  ...
  static MapDocumentRequireStatus = class {
    static readonly dtcMapDocumentTypeStatus: iKeyValuePair<
      Enums.MapDocumentRequireStatus,
      string
    >[] = [
  ...
  static ApiActionCode = class {
    ...
    //Update thông tin faceID finger
    static UpdateFinger = "UpdateFinger";
    //new
    ...
    static SavePositionWorkfield = "SavePositionWorkfield";
    ...
    static UploadAttachment = "UploadAttachment";
    static Done = "Done";

    static SetupFormRE = "SetupFormRE";
    static DeleteConstruction = "DeleteConstruction";
    static LoadListConstruction = "LoadListConstruction";
    ...
    static GetListEmpAndAreaByConfRegionID = "GetListEmpAndAreaByConfRegionID";
    static GetProcessValuationREByMA = "GetProcessValuationREByMA";
    static SaveDataRE = "SaveDataRE";
    static GetProcessValuationEByID = "GetProcessValuationEByID";
