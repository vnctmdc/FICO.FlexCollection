...
@observer
export default class ReFactoriesSrc extends Component<iProps, iState> {
  ...
  _pickImage = async (idPVRECon: number, RefCode: string) => {
    //console.log("idPVRECon", idPVRECon);
  ...
  async LoadData() {
    try {
      ...
      req.MACode2 = SMX.MortgageAssetCode2.REFactories;
  ...
  async AddNewItemConstruction() {
    try {
      console.log("Hihihi ok", this.state.ProcessValuationREConstruction);
      ...
      let pvREC = this.state.ResetProcessValuationREConstruction;
  ...
  async getListContruction() {
    try {
      ...
      //console.log("Danh sách CTXD", res.ListProcessValuationREConstruction);
  ...
  async UpdateItemCon(id) {
    ...
    try {
      ...
      //console.log("Ban ghi moi nhap", res);
  ...
  renderItem(index: number, item: ProcessValuationREConstruction) {
    //console.log("HIHIfhdhfdh", item.ConstructionType);
    //console.log("CYSMTA", item);
    //console.log("Danh sach anh len", item.ListAttachmentImage);
                  ...
                  <View style={styles.ItemKS}>
                    ...
                    <View style={{ flex: 1 }}>
                      <TextInput
                        ...
                        style={[Theme.TextInput]}
                        onChangeText={(val) => {
                          // pvRE.InfactLandAreaPrivate = Utility.ConvertToDecimal(
                          //   val
                          // );
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      let reset = this.state
                        .ResetProcessValuationREConstruction;
                      this.setState({
                        temppvRECon: reset,
                  ...
                  <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    >
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() => {
                          this.setState({ showConfirmAddNew: false });
                        }}
                      >
                    ...
                    <View style={{ flex: 2, flexDirection: "row" }}>
                      ...
                      <View style={{ flex: 1 }}>
                        <DropDownBox
                          ...
                          OnSelectedItemChanged={(val) => {
                            // itemCon.ConstructionType = val.SystemParameterID;
                            // this.setState({ ProcessValuationREConstruction: itemCon });
