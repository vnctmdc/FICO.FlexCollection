...
@observer
export default class RECondominiumImagesSrc extends Component<iProps, iState> {
                            ...
                            <TouchableOpacity
                                ...
                                onPress={() => {
                                    this.props.navigation.navigate("REResidentialImagesSrc", {
                                      ...
                                      MortgageAssetID: pvE.MortgageAssetID,
                                      Customer: pvE.CustomerName,
                                      InfactAddress: pvE.InfactAddress
                                    });
                                  }}
                            >
                                <LinearGradient
